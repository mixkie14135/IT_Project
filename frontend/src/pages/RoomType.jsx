// src/pages/RoomType.jsx (แก้ไขฉบับสมบูรณ์)
...
export default function RoomType() {
  ...
  useEffect(() => {
    ...
    // ********** การแก้ไข: ป้องกันการเรียก API เมื่อ slug เป็น undefined **********
    if (!slug) {
      setLoadingType(false);
      setError("ไม่พบประเภทห้องที่ต้องการ (URL ผิดพลาด)");
      return;
    }
    // ********** จบการแก้ไข **********
    ...
    roomApi
      ...
      .catch(
        (err) => alive && setError(err.message || "โหลดข้อมูลประเภทไม่สำเร็จ")
      )
  ...
  const cardSpecs = useMemo(() => {
    ...
    return arr
      ...
      .slice(0, 4);
  }, [typeInfo?.amenities]); // HERO: ใช้รูปห้องแรก ถ้าไม่มี → ไม่ตั้ง background
                  ...
                  <div className="roomBody">
                    ...
                    <div className="roomActions">
                      ...
                      <button
                        ...
                        onClick={() =>
                          canBook &&
                          navigate(`/bookings/bookingroom/${r.room_id}`)
                        }
        ...
        <section className="contact">
          ...
          <div className="container">
            ...
            <ul className="contactList">
                           {" "}
              <li>
                123 หมู่6 ใกล้แยก รร การบิน ถนน บางเลน ตำบล ห้วยขวาง
                อำเภอกำแพงแสน นครปฐม 73180
              </li>
                            <li>082 466 6689</li>           {" "}
            </ul>
                     {" "}
